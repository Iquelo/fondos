			...
			$shortcodes = array(
				...
				'flat_icon_box' => array(
					'attr' => array(
						'type' => 'select',
						'box_title' => 'text',
						'box_background_color' => 'text',
					),
					'desc' => array(
						'type' => 'Select Image',
						'box_title' => 'Enter box title here',
						'box_background_color' => 'Enter text color (ex: ff0000)',
					),
					'options' => array(
						'bag' => 'bag',
						'book' => 'book',
				...
				'colored_area' => array(
					...
					'desc' => array(
						'bg_color' => 'Enter box background color (ex: FC5136)',
						'text_color' => 'Enter text color (ex: ffffff)',
					),
					'content' => TRUE,
					'content_text' => 'Enter box content',
				),
...
function cd_meta_box_save( $post_id )
{
	...
	update_post_meta( $post_id, 'page_title_state', $chk );
